  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const { data } = await axios.get(`${BASE_URL}/enrollments/${courseId}/certificate`, cfg);
        setCert(data);
    ...
    <>
      ...
      <div id="cert-page">
        <div id="cert-box">
          ...
          {/* Faint mandala dot effect in background */}
          ...
          {/* Corner flourish accents (Text symbols positioned at corners) */}
