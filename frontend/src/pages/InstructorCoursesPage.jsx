...
const InstructorCoursesPage = () => {
  ...
  // Platform settings (fetched from /api/settings for dynamic categories)
  ...
  const addQuestion = (type) => {
    ...
    const newQuestion = {
      ...
      ...(type === 'choice' && { options: ['', ''], correctOption: 0 })
  ...
  // Fetch platform settings for dynamic category list
  ...
  useEffect(() => {
    ...
    const fetchSettings = async () => {
      ...
      try {
        ...
        // Pre-select first category once settings load

        if (data?.courseCategories?.length > 0) {

          setCategory(prev => prev || data.courseCategories[0]);
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          ...
          const { data: statsData } = await axios.get(`${BASE_URL}/stats/instructor`, config);

          setInstructorStats(statsData);

        } catch (statsErr) {

          console.log('Error fetching instructor stats:', statsErr);
   ...
   * Upload a local file to /api/upload and return the hosted URL.

   * @param {File} file - The file selected from the file picker

   * @param {'image'|'video'} type - Whether this is the thumbnail or intro video
  ...
  const handleFileUpload = async (file, type) => {
    ...
    const setUrl = type === 'image' ? setImage : setIntroVideoUrl;
  ...
  const handleCreateCourse = async (e) => {
    ...
    try {
      ...
      setCategory(platformSettings?.courseCategories?.[0] || '');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <button 
                ...
                onClick={() => setSelectedStat({ 
                  ...
                  description: `All ${instructorStats?.totalStudents || 0} unique students enrolled across your courses`,
                  ...
                  students: instructorStats?.allStudents || []

                })}

                className="bg-white dark:bg-zinc-900 rounded-xl shadow-md p-4 border border-gray-100 dark:border-zinc-800 hover:shadow-lg transition-all cursor-pointer transform hover:-translate-y-1 text-left"
              ...
              >
                ...
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Total Students</p>

                <p className="text-2xl font-black text-gray-900 dark:text-white">{instructorStats?.totalStudents || 0}</p>
              ...
              <button 
                ...
                onClick={() => setSelectedStat({ 
                  ...
                  value: instructorStats?.paidStudentCount || 0,

                  description: `${instructorStats?.paidStudentCount || 0} students who have paid for at least one course`,
                  ...
                  students: instructorStats?.paidStudents || []
              ...
              >
                ...
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Paid Students</p>

                <p className="text-2xl font-black text-gray-900 dark:text-white">{instructorStats?.paidStudentCount || 0}</p>
              ...
              <button 
                ...
                onClick={() => setSelectedStat({ 
                  ...
                  value: instructorStats?.freeStudentCount || 0,

                  description: `${instructorStats?.freeStudentCount || 0} students with only free course access`,
                  ...
                  students: instructorStats?.freeStudents || []
              ...
              >
                ...
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Free Students</p>

                <p className="text-2xl font-black text-gray-900 dark:text-white">{instructorStats?.freeStudentCount || 0}</p>
              ...
              <button 
                ...
                onClick={() => setSelectedStat({ 
                  ...
                  value: `ETB ${instructorStats?.totalRevenue?.toLocaleString() || 0}`,

                  description: `Gross revenue from all completed payments. Platform takes ${instructorStats?.platformCommissionPercentage || 20}% commission.`,

                  icon: DollarSign,

                  color: 'indigo',

                  extra: `Platform Fee: ${instructorStats?.platformCommissionPercentage || 20}%`

                })}

                className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl shadow-md p-4 text-white hover:shadow-lg transition-all cursor-pointer transform hover:-translate-y-1 text-left"
              ...
              >
                ...
                <p className="text-xs font-semibold text-white/80 mb-1">Total Revenue</p>

                <p className="text-2xl font-black text-white">{instructorStats?.totalRevenue?.toLocaleString() || 0}</p>
              ...
              <button 
                ...
                onClick={() => setSelectedStat({ 
                  ...
                  value: `ETB ${instructorStats?.balance?.toLocaleString() || 0}`,

                  description: `Your current withdrawable balance after ${instructorStats?.platformCommissionPercentage || 20}% platform commission and withdrawals.`,

                  icon: Wallet,

                  color: 'amber',

                  extra: `Total Withdrawn: ETB ${instructorStats?.totalWithdrawn?.toLocaleString() || 0}`

                })}

                className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl shadow-md p-4 text-white hover:shadow-lg transition-all cursor-pointer transform hover:-translate-y-1 text-left"
              ...
              >
                ...
                <p className="text-xs font-semibold text-white/80 mb-1">Balance</p>

                <p className="text-2xl font-black text-white">{instructorStats?.balance?.toLocaleString() || 0}</p>
              ...
              <Link 
                ...
                to="/instructor/withdrawal" 

                className="bg-gradient-to-br from-pink-500 to-rose-600 rounded-xl shadow-md p-4 text-white hover:shadow-lg transition-all transform hover:-translate-y-1 flex flex-col justify-between"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-white/80 mb-1">Withdrawals</p>

                  <p className="text-2xl font-black text-white mb-1">{instructorStats?.pendingWithdrawals || 0}</p>

                  <p className="text-[10px] font-medium text-white/70">pending</p>
        ...
        {selectedStat && (
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setSelectedStat(null)}>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden border border-gray-200 dark:border-zinc-800" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className={`w-14 h-14 rounded-xl flex items-center justify-center ${
                      ...
                      selectedStat.color === 'blue' ? 'bg-blue-100 dark:bg-blue-900/30' :

                      selectedStat.color === 'emerald' ? 'bg-emerald-100 dark:bg-emerald-900/30' :

                      selectedStat.color === 'purple' ? 'bg-purple-100 dark:bg-purple-900/30' :

                      selectedStat.color === 'indigo' ? 'bg-indigo-100 dark:bg-indigo-900/30' :

                      selectedStat.color === 'amber' ? 'bg-amber-100 dark:bg-amber-900/30' :

                      'bg-gray-100 dark:bg-gray-800'

                    }`}>

                      <selectedStat.icon className={`w-7 h-7 ${

                        selectedStat.color === 'blue' ? 'text-blue-600 dark:text-blue-400' :

                        selectedStat.color === 'emerald' ? 'text-emerald-600 dark:text-emerald-400' :

                        selectedStat.color === 'purple' ? 'text-purple-600 dark:text-purple-400' :

                        selectedStat.color === 'indigo' ? 'text-indigo-600 dark:text-indigo-400' :

                        selectedStat.color === 'amber' ? 'text-amber-600 dark:text-amber-400' :
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-black text-gray-900 dark:text-white">{selectedStat.title}</h3>

                      <p className="text-sm text-gray-500 dark:text-gray-400">{selectedStat.description}</p>
                  ...
                  <button 
                    ...
                    className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-zinc-800 hover:bg-gray-200 dark:hover:bg-zinc-700 flex items-center justify-center transition-colors"
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                ...
                {selectedStat.extra && !selectedStat.students && (

                  <div className="bg-gray-50 dark:bg-zinc-800/50 rounded-xl p-4 border border-gray-100 dark:border-zinc-700 mb-4">

                    <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">{selectedStat.extra}</p>
                ...
                {selectedStat.students && selectedStat.students.length > 0 ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <p className="text-lg font-bold text-gray-900 dark:text-white">
                        ...
                        {selectedStat.value} {selectedStat.listType === 'paid' ? 'Paid' : selectedStat.listType === 'free' ? 'Free' : 'Total'} Student{selectedStat.value !== 1 ? 's' : ''}
                    ...
                    {selectedStat.students.map((student, index) => (

                      <div key={student._id} className="bg-gray-50 dark:bg-zinc-800/50 rounded-xl p-4 border border-gray-100 dark:border-zinc-700 hover:border-gray-300 dark:hover:border-zinc-600 transition-colors">
                        ...
                        <div className="flex items-start justify-between mb-3">
                          ...
                          {student.hasPaidCourse && (

                            <div className="text-right">

                              <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Total Paid</p>

                              <p className="text-lg font-black text-emerald-600 dark:text-emerald-400">

                                ETB {student.totalPaid?.toLocaleString() || 0}
                                ...
                                <div className="flex items-center gap-3 mt-1">
                                  ...
                                  {course.isPaid ? (
                                    ...
                                    <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400">
                                      ...
                                      Paid: ETB {course.paymentAmount?.toLocaleString()}
                        ...
                        <div className="mt-3 text-xs text-gray-500 dark:text-gray-400">
                          ...
                          First enrolled: {new Date(student.enrolledAt).toLocaleDateString('en-US', { 
                  ...
                  /* Non-student panels - show extra info */
          ...
          <form onSubmit={handleCreateCourse} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                {(platformSettings?.courseCategories?.length > 0

                  ? platformSettings.courseCategories

                  : ['General','Programming','Design','Business','Marketing','Photography','Music','Health & Fitness','Language','Science']
            ...
            <div>
              ...
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Course Thumbnail Image</label>

              <div className="space-y-2">

                {/* File picker */}

                <label className={`flex items-center gap-3 cursor-pointer w-full border-2 border-dashed rounded-xl p-3 transition-colors ${

                  uploadingImage ? 'border-indigo-300 bg-indigo-50 dark:bg-indigo-900/20' : 'border-gray-300 dark:border-zinc-600 hover:border-indigo-400 dark:hover:border-indigo-500'
                  ...
                  {uploadingImage ? (
                    ...
                    <><Loader2 className="h-5 w-5 animate-spin text-indigo-500" /><span className="text-sm text-indigo-600 dark:text-indigo-400 font-medium">Uploading image...</span></>

                  ) : (

                    <><svg className="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg><span className="text-sm text-gray-500 dark:text-gray-400">Browse local image file</span></>
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-zinc-800 text-gray-900 dark:text-white border border-gray-300 dark:border-zinc-700 p-3 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-sm"

                />

                {image && (

                  <img src={image} alt="Thumbnail preview" className="h-24 w-auto rounded-lg object-cover border border-gray-200 dark:border-zinc-700" onError={e => e.target.style.display='none'} />

                )}

              </div>

              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">This is the course thumbnail/cover image, not a video</p>
            ...
            <div>
              ...
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                ...
                {isPaid ? 'Intro Video (local file or Google Drive link)' : 'Intro Video (local file or YouTube/Social link)'}
              ...
              <div className="space-y-2">
                ...
                <label className={`flex items-center gap-3 cursor-pointer w-full border-2 border-dashed rounded-xl p-3 transition-colors ${
                  ...
                  uploadingVideo ? 'border-indigo-300 bg-indigo-50 dark:bg-indigo-900/20' : 'border-gray-300 dark:border-zinc-600 hover:border-indigo-400 dark:hover:border-indigo-500'
                  ...
                  {uploadingVideo ? (
                    ...
                    <><Loader2 className="h-5 w-5 animate-spin text-indigo-500" /><span className="text-sm text-indigo-600 dark:text-indigo-400 font-medium">Uploading video...</span></>

                  ) : (

                    <><svg className="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.069A1 1 0 0121 8.882v6.236a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg><span className="text-sm text-gray-500 dark:text-gray-400">Browse local video file</span></>
                ...
                <input
                  ...
                  placeholder={isPaid ? 'https://drive.google.com/file/d/your-video-id/view' : 'https://www.youtube.com/watch?v=...'}
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                ...
                {isPaid ? 'Upload locally or paste a Google Drive shareable link' : 'Upload locally or paste a YouTube/social media link'}
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl max-w-2xl w-full border border-gray-200 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateCourse} className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <label className={`flex items-center gap-3 cursor-pointer w-full border-2 border-dashed rounded-xl p-3 transition-colors ${
                    ...
                    uploadingImage ? 'border-indigo-300 bg-indigo-50' : 'border-gray-300 hover:border-indigo-400'
                    ...
                    {uploadingImage ? (
                      ...
                      <><Loader2 className="h-4 w-4 animate-spin text-indigo-500" /><span className="text-sm text-indigo-600 font-medium">Uploading...</span></>

                    ) : (

                      <><svg className="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg><span className="text-sm text-gray-500">Browse local image</span></>
                  ...
                  <input
                    ...
                    className="w-full bg-white text-gray-900 border border-gray-400 p-2 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm"

                  />

                  {image && (

                    <img src={image} alt="Preview" className="h-20 w-auto rounded-lg object-cover border border-gray-200" onError={e => e.target.style.display='none'} />
              ...
              <div>
                ...
                <label className="block text-sm font-semibold text-gray-700 mb-2">Intro Video</label>

                <div className="space-y-2">

                  <label className={`flex items-center gap-3 cursor-pointer w-full border-2 border-dashed rounded-xl p-3 transition-colors ${

                    uploadingVideo ? 'border-indigo-300 bg-indigo-50' : 'border-gray-300 hover:border-indigo-400'
                    ...
                    {uploadingVideo ? (
                      ...
                      <><svg className="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.069A1 1 0 0121 8.882v6.236a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg><span className="text-sm text-gray-500">Browse local video</span></>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {courses.map(course => (
              ...
              <div key={course._id} className="group bg-white dark:bg-zinc-900 rounded-[32px] border border-gray-100 dark:border-zinc-800 overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col transform hover:-translate-y-2">
                ...
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 bg-white dark:bg-zinc-900 text-gray-900 dark:text-white px-2.5 py-1 rounded-xl font-black text-[10px] shadow-xl">
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="px-2 py-0.5 bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 rounded-full text-[8px] font-black uppercase tracking-widest leading-none">
                    ...
                    {course.level && course.level !== "All Levels" && (
                      ...
                      <span className="px-2 py-0.5 bg-purple-50 dark:bg-purple-900/40 text-purple-600 dark:text-purple-400 rounded-full text-[8px] font-black uppercase tracking-widest leading-none border border-purple-100 dark:border-purple-800/50">
                  ...
                  <h3 className="text-base font-black text-gray-900 dark:text-white mb-2 line-clamp-2 leading-tight group-hover:text-indigo-600 transition-colors">

                    {course.title}

                  </h3>

                  <div className="flex items-center gap-2 mt-auto pt-3 border-t border-gray-50 dark:border-zinc-800">

                    <div className="flex items-center gap-1.5">

                      <div className="w-5 h-5 rounded-full bg-indigo-600 flex items-center justify-center font-black text-white text-[9px]">
